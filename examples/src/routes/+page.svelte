<script lang="ts">
  ...
  import { RunedForm } from 'runed-forms';
  import { z } from 'zod';
...
<Card.Root class="mx-auto max-w-sm">
  ...
  <Card.Content>
    <form class="grid gap-4">
      ...
      <Button type="submit" class="w-full" disabled={!form.valid}>Login</Button>
    </form>
  </Card.Content>
</Card.Root>

{#snippet errors(issues: Issues)}
  <div class="flex text-sm text-muted-foreground flex-col gap-0.5">
